...
class Export_SQLDUMP:
    def export_sql_dump(self,db_name,query):
        ...
        f1 = fileOpsObj.filereader("/Users/yash/database_5408_project_create_insert/"+db_name+"_SQLDUMP.sql")
...
# query = "export sql dump '/Users/yash/Desktop'"
# sqldumpObj.export_sql_dump("5408_group2",query)